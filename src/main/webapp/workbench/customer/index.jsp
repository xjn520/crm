...
<script type="text/javascript">
	...
	$(function (){
		...
		$("#addBtn").click(function (){
			$.ajax({
				url:"workbench/customer/getUserList.dao",
				type:"get",
				dataType:"json",
		...
		$("#editBtn").click(function (){
			...
			}else if ($xz.length>1)
			{
				...
				$.ajax({
					url:"workbench/customer/update.dao",
					data:{
		...
		$("#updateBtn").click(function (){
			$.ajax({
				url:"workbench/customer/updateCustomer.dao",
				data:{
					"id":$.trim($("#edit-id").val()),
					"owner":$.trim($("#edit-0wner").val()),
		...
		$("#removeBtn").click(function (){
			...
			}else if ($xz.length>1)
			{
				...
				if (confirm("你确定要删除吗？"))
				{
					var customerId=$xz.val();
					$.ajax({
						url:"workbench/customer/delete.dao",
						data:{
							"customerId":customerId
						},
						type:"get",
	...
	{
		$.ajax({
			url:"workbench/customer/CustomerList.dao",
			data:{
				"pageNo":pageNo,
				"pageSize":pageSize
			},
			...
			success:function (data){
				...
				$.each(data.dataList,function (i,n){
					...
					html+='<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/customer/detail.dao?id='+n.id+'\';">'+n.name+'</a></td>';
					html+='<td>'+n.owner+'</td>';
					html+='<td>'+n.phone+'</td>';
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="edit-0wner">

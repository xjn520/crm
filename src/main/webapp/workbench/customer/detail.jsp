...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#addBtn").click(function (){
			...
			$.ajax({
				url:"workbench/customer/saveRemark.dao",
				data:{
					"customerId":"${c.id}",
		...
		$("#updateRemarkBtn").click(function (){
			var id=$("#remarkId").val();//这个是customerRemark的ID
			var noteContent=$("#noteContent").val();
			$.ajax({
				url:"workbench/customer/updateRemark.dao",
				data:{
					"remarkId":id,
					"noteContent":noteContent
				},
		...
		$("#deleteTranBtn").click(function (){
			var tranId=$("#hidden-id").val();
			$.ajax({
				url:"workbench/customer/deleteTran.dao",
				data:{
					"tranId":tranId
				},
				type:"get",
	...
	{
		$.ajax({
			url:"workbench/customer/showTran.dao",
			type:"get",
			dataType:"json",
			success:function (data){
				var html="";
				$.each(data,function (i,n){
					html+='<tr>';
					html+='<input type="hidden" value="'+n.id+'" id="hidden-id">'
					html+='<td><a href="workbench/transaction/detail.do?id='+n.id+'" style="text-decoration: none;">'+n.owner+'</a></td>';
					html+='<td>'+n.money+'</td>';
					html+='<td>'+n.stage+'</td>';
	...
	{
		$.ajax({
			url:"workbench/customer/showRemark.dao",
			data:{
				"customerId":"${c.id}"
			},
			type:"get",
			...
			success:function (data){
				...
				$.each(data.list,function (i,n){
					...
					html+='<font color="gray">联系人</font> <font color="gray">-</font> <b>${c.name}</b> <small style="color: gray;"> '+n.createTime+' 由'+data.user+'</small>';
	...
	function deleteRemark(id)
	{
		...
		{
			$.ajax({
				url:"workbench/customer/deleteRemark.dao",
				data:{
					"remarkId":id
				},
				type:"get",
	...
	function editRemark(id)/*备注修改按钮*/
	{
		$("#remarkId").val(id);
		$("#editRemarkModal").modal("show");
	}
</script><%--<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;"></span></a>--%>
	<%--<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>--%>
...
<div class="modal fade" id="editRemarkModal" role="dialog">
	...
	<div>
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div>
				<a href="workbench/transaction/add.dao" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>新建交易</a>
			</div>
		</div>
	</div>

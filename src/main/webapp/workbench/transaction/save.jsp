...
<%--	Stage2Possibility.properties这个文件
		表示的是阶段和键值对之间的对应关系，将来，通过stage，以及对应的关系，来取得这个可能性值
...
<script type="text/javascript">
	...
	$(function (){
		...
		$("#searchActivity").keydown(function (event){
			...
			{
				$.ajax({
					url:"workbench/transaction/searchActivity.dao",
					data:{
		...
		$("#searchContacts").keydown(function (event){
			...
			{
				$.ajax({
					url:"workbench/transaction/searchContacts.dao",
					data:{
						"aname":$.trim($("#searchContacts").val())
					},
					type:"get",
					dataType:"json",
					success:function (data){
